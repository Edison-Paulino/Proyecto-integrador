"""
Django settings for estacion_P project.
...
SECRET_KEY = 'django-insecure-&8npgkcmam7q)&a!n3m_kxr3_m1xo)1wg7!jp#r%=kd7@8bj_k'
...
ROOT_URLCONF = 'estacion_P.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS':  [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'estacion_A', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
